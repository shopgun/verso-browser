...
module.exports = PageSpread = (function() {
  ...
  PageSpread.prototype.getContentRect = function() {
    var i, len, pageEl, pageRect, parentRect, rect, ref, ref1, ref2, ref3, ref4;
    rect = {
      top: null,
      left: null,
      right: null,
    ...
    parentRect = this.getEl().getBoundingClientRect();
    ref = this.getPageEls();
