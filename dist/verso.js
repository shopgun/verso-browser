...
Verso = (function() {
  function Verso(el1, options1) {
    ...
    this.scrollerEl.addEventListener('contextmenu', this.contextmenu.bind(this));
    return;
  }
  ...
  Verso.prototype.contextmenu = function(e) {
    e.preventDefault();
