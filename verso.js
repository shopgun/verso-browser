...
module.exports = PageSpread = (function() {
  ...
  PageSpread.prototype.getOverlayEls = function() {
    return this.getEl().querySelectorAll('.verso-page-spread__overlay');
  };
...
Verso = (function() {
  ...
  Verso.prototype.getCoordinateInfo = function(x, y, pageSpread) {
    var contentRect, info, j, k, len, len1, overlayEl, overlayEls, pageEl, pageEls, pageRect;
    info = {
      x: x,
      y: y,
      contentX: 0,
    ...
    if (info.pageEl != null) {
      ...
      info.isInsidePageX = info.pageX >= 0 && info.pageX <= pageRect.width;
      info.isInsidePageY = info.pageY >= 0 && info.pageY <= pageRect.height;
      info.isInsidePage = info.isInsidePageX && info.isInsidePageY;
    }
    return info;
  };
