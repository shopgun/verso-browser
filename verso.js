...
module.exports = Animation = (function() {
  function Animation(el1) {
    this.el = el1;
    this.run = 0;
    return;
  }

  Animation.prototype.transform = function(x, y, scale) {
    this.el.style.transform = "translate3d(" + x + ", " + y + ", 0) scale3d(" + scale + ", " + scale + ", 1)";
    return this;
  };

  Animation.prototype.animate = function(options, callback) {
    var completed, duration, easing, el, ref, ref1, ref2, ref3, ref4, run, scale, x, y;
    if (options == null) {
      options = {};
    }
    el = this.el;
...
Verso = (function() {
  ...
  Verso.prototype.buildPageIds = function(pageSpreads) {
    var pageIds;
    pageIds = {};
    pageSpreads.forEach((function(_this) {
      return function(pageSpread, i) {
  ...
  Verso.prototype.panEnd = function(e) {
    ...
    if (this.transform.scale > 1 || this.pinching === true) {
      return;
    }
