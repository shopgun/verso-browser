...
Verso = (function() {
  ...
  Verso.prototype.doubleTap = function(e) {
    var activePageSpread, maxZoomScale, point, position, scale, zoomEvent, zoomedIn;
    activePageSpread = this.getActivePageSpread();
