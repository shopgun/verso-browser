...
module.exports = PageSpread = (function() {
  ...
  PageSpread.prototype.getContentRect = function() {
    var i, len, pageEl, pageEls, pageRect, rect, ref, ref1, ref2, ref3;
    pageEls = this.getPageEls();
    rect = {
      top: null,
      left: null,
      right: null,
    ...
    for (i = 0, len = pageEls.length; i < len; i++) {
      pageEl = pageEls[i];
    ...
    rect.top = (ref = rect.top) != null ? ref : 0;
    rect.left = (ref1 = rect.left) != null ? ref1 : 0;
    rect.right = (ref2 = rect.right) != null ? ref2 : 0;
    rect.bottom = (ref3 = rect.bottom) != null ? ref3 : 0;
