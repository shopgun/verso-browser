...
Verso = (function() {
  ...
  Verso.prototype.refresh = function(position) {
    if (position == null) {
      position = 0;
    }
    this.pageSpreadEls = this.el.querySelectorAll('.verso__page-spread');
