...
module.exports = Page = (function(superClass) {
  ...
  Page.prototype.updatePosition = function(position) {
...
module.exports = Pages = (function() {
  ...
  Pages.prototype.toArray = function() {
    return this.pages;
  };
  ...
  Pages.prototype.pause = function() {
    this.paused = true;
  };
...
module.exports = Progress = (function() {
  ...
  Progress.prototype.updateProgress = function() {
    var progress;
    progress = parseInt((this.verso.pageIndex + 1) / this.verso.pages.count() * 100);
...
module.exports = Verso = (function(superClass) {
  ...
  Verso.prototype.keyUp = function(e) {
    var ref, ref1;
  ...
  Verso.prototype.panStart = function(e) {
    ...
    pageEl = e.target;
    pageIndex = null;
    while ((pageEl.parentNode != null) && !pageEl.className.match(/\bverso__page\b/)) {
  ...
  Verso.prototype.panMove = function(e) {
    ...
    delta = this.swipeDirection === 'horizontal' ? e.deltaX : e.deltaY;
    delta = delta / this.el.offsetWidth * 100;
  ...
  Verso.prototype.panEnd = function(e) {
    ...
    nextPage = this.pages.at(this.pan.pageIndex + 1);
    if (prevPage != null) {
      prevPage.updatePosition(prevPage.transformPosition);
    }
    currPage.updatePosition(currPage.transformPosition);
    if (nextPage != null) {
      nextPage.updatePosition(nextPage.transformPosition);
    }
...
module.exports = Zoom = (function(superClass) {
  ...
  Zoom.prototype.toggleScale = function(x, y) {
    if (this.scale === this.minScale) {
      ...
      this.scaleAtEdges();
      this.transform(this.transitionDuration, this.enableScroll.bind(this));
  ...
  Zoom.prototype.touchEnd = function(e) {
    e.preventDefault();
  };
  ...
  Zoom.prototype.pinchStart = function(e) {
    ...
    this.startScale = this.scale;
    this.disableScroll();
    this.scaleAtOrigin(e.center.x, e.center.y, this.startScale * e.scale);
    this.transform();
  };
  ...
  Zoom.prototype.pinchEnd = function(e) {
    ...
    if (this.scale > this.maxScale) {
      this.scaleAtOrigin(e.center.x, e.center.y, this.maxScale);
      this.scaleAtEdges();
    } else if (this.scale <= this.minScale) {
      this.x = 0;
      this.y = 0;
  ...
  Zoom.prototype.disableScroll = function() {
    ...
    this.y -= (scrollTop - this.initialScrollTop) / childHeight * 100;
    this.transform();
  ...
  Zoom.prototype.scaleAtOrigin = function(x, y, scale) {
    ...
    x -= rect.left;
    y -= rect.top;
    x = x / (rect.width / this.scale) * 100;
    y = y / (rect.height / this.scale) * 100;
