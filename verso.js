...
Verso = (function() {
  ...
  Verso.prototype.getCoordinateInfo = function(x, y, pageSpread) {
    ...
    if (info.pageEl != null) {
      info.isInsideContentX = info.contentX >= 0 && info.contentX <= contentRect.width;
      info.isInsideContentY = info.contentY >= 0 && info.contentY <= contentRect.height;
